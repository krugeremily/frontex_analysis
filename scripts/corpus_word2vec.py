...
# #remove selected file from pre-processed data folder, that can not be read by pdf plumber properly
# os.remove(os.path.join(preprocessed_data, 'annual_risk_analysis_2011.txt'))
...
annual_reports_raw = [f for f in sorted(os.listdir(raw_data)) if 'analysis' in f and 
                      f != 'common-integrated-risk-analysis-model-version-summary-booklet-2.1.pdf' and
                      f != 'annual_risk_analysis_2011.pdf']
